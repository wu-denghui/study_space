package com.goodhealth.algorithm.Algorithm.TwitterSnow;

/**
 * @ClassName UniqueIdUtil
 * @Description TODO  Twitter的分布式自增ID雪花算法snowflake (Java版)
 * @Author WDH
...
public class UniqueIdUtil {
     ...
     * 起始的时间戳
     */
    private final static long START_STMP = 1535206465631L;
